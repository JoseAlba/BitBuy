...
<body style="background-color: rgb(246,246,246);">
    ...
    <div class="small-12 medium-3 columns" style="margin: 0; padding: 0;">
        ...
        <div class="dash_board" style="width: 100%">
            <a href="#"><p> <img src="img/iconmonstr-dashboard-5-240.png" alt="dashboard"> Dashboard</p></a>
    ...
    <div class=" small-12 medium-9 columns" style="margin: 0; padding: 0;">
        <iframe name="right-side" src="vertical-timeline" frameborder=0 style="  padding: 0;
                  margin: 0;
                  border: none;
                  /*display:inline;*/
                  position: absolute;
